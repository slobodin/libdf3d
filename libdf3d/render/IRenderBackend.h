...
public:
    ...
    virtual void bindVertexBuffer(VertexBufferDescriptor vb, int, int) = 0;
    ...
    virtual void bindIndexBuffer(IndexBufferDescriptor ib, int, int) = 0;
    virtual void updateIndexBuffer(IndexBufferDescriptor ib, size_t indicesCount, const void *data) = 0;

    virtual TextureDescriptor createTexture2D() = 0;
    virtual TextureDescriptor createTextureCube() = 0;
