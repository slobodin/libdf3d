...
void bindProcessors(Table &df3dNamespace)
{
...

    {
        ...
        scGraphProcessor
            ...
            .Overload<Entity(SceneGraphComponentProcessor::*)(df3d::Id)const>(_SC("getByName"), &SceneGraphComponentProcessor::getByName)
            .Overload<Entity(SceneGraphComponentProcessor::*)(Entity, df3d::Id)const>(_SC("getByName"), &SceneGraphComponentProcessor::getByName)
